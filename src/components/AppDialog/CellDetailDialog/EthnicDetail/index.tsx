    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        ...
        <BlurCard title="Land Cells">
          <p className="mt-1 text-lg font-bold break-words text-sky-300">
            {data.ethnicCells.length.toLocaleString()}
          </p>
        </BlurCard>
        <BlurCard title="Nations Spanned">
          <p className="mt-1 text-lg font-bold break-words text-amber-300">{data.nations.length}</p>
        </BlurCard>
        <BlurCard title="Avg Pop / Cell">
          <p className="mt-1 text-lg font-bold break-words text-emerald-300">
